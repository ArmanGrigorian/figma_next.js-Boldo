	...
	return (
		<form onSubmit={handleLogIn} className="px-20 max-lg:px-10 max-md:px-5">
			<fieldset className="bg-custom-dark-blue w-[min(100%,600px)] m-auto p-9 shadow-xl rounded-tl-[56px] rounded-tr-[16px] rounded-br-[56px] rounded-bl-[16px] flex flex-col justify-center items-center dark:shadow-none">
				<label
					htmlFor="inputLogin"
					className="mb-1 text-custom-white text-lg font-Manrope font-bold tracking-wide">
					Login
				</label>
				<input
					className="border font-Manrope shadow-xl rounded w-full mb-3 py-1 px-5 peer/login"
					type="text"
					name="userLogin"
					id="inputLogin"
					required
				/>
				<p className="peer-valid/login:hidden font-Manrope text-custom-green">Login is required</p>
				...
				<input
					className="border font-Manrope shadow-xl rounded w-full mb-3 py-1 px-5 peer/password"
					type="password"
					name="userPassword"
					id="inputPassword"
					required
				/>
				<p className="peer-valid/password:hidden font-Manrope text-custom-green">
